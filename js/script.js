...
var parts = {
  ...
  brain: {
    ...
    twitter: marks[0].twitter + ": having a stroke, you shouldn’t need to worry if Medi-Cal will cover your treatment. #MediCalMatters #CADem15",
  ...
  heart: {
    ...
    twitter: "Ricardo has a heart condition, but b/c he has Medi-Cal coverage he can’t get his checkups. " + marks[0].twitter + " #MediCalMatters #CADem15",
  ...
  knee: {
    ...
    twitter: "In an accident each minute counts--you shouldn’t need to travel further for an ER that takes Medi-Cal #MediCalMatters " + marks[0].twitter + " #CADem15",
  ...
  lungs: {
    ...
    twitter: "No one should have to rely on expired asthma medicine b/c they’re covered by Medi-Cal. " + marks[0].twitter + " #MediCalMatters #CADem15",
  ...
  foot: {
    ...
    twitter: "When Medi-Cal patients like Tioy have to wait for care, it means higher costs & worse health #MediCalMatters " + marks[0].twitter + " #CADem15",
  ...
  leftArm: {
    ...
    twitter: "9-yo Jenevy went months w/o care for a dangerous allergy, b/c she’s covered by Medi-Cal. " + marks[0].twitter + " #MediCalMatters #CADem15",
  ...
  rightArm: {
    ...
    twitter: "How can musician Gilberto work when he has to wait months for an arthritis appointment? #MediCalMatters " + marks[0].twitter + " #CADem15",
