...
var parts = {
  ...
  foot: {
    ...
    twitter: "When Medi-Cal patients like Tioy have to wait for care, it means higher costs & worse health " + marks[0].twitter,
...
$("#twitter").click( function() {
    var twitterUrl = "http://twitter.com/intent/tweet?",
        text = "text=" + parts[part].twitter + " http://mattsedlar.net/development/social-media-app/" + parts[part].image;
