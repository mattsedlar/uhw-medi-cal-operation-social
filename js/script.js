...
var parts = {
  ...
  brain: {
    ...
    facebook: "After Luz was rushed to the Emergency Room with a stroke, she discovered that her Medi-Cal insurance wouldn't cover the surgery. Join the campaign and take action to fully fund Medi-Cal for California.",
  ...
  heart: {
    ...
    twitter: "Ricardo has a heart condition, but b/c he has Medi-Cal coverage he can't get his checkups. " + marks[0].twitter + " " + marks[1].twitter,
    facebook: "Ricardo was born with a heart murmur, but because he is insured by Medi-Cal, he can't get the regular check ups he needs to stay healthy. Join the campaign and take action to fully fund Medi-Cal for California.",
  ...
  knee: {
    ...
    twitter: "In an accident each minute counts--you shouldn't need to travel further for an ER that takes Medi-Cal " + marks[0].twitter + " " + marks[1].twitter,
  ...
  lungs: {
    ...
    twitter: "No one should have to rely on expired asthma medicine b/c they're covered by Medi-Cal. " + marks[0].twitter + " " + marks[1].twitter,
  ...
  leftArm: {
    ...
    twitter: "9-yo Jenevy went months w/o care for a dangerous allergy, b/c she's covered by Medi-Cal. " + marks[0].twitter + " " + marks[1].twitter,
    facebook: "It took 9-year-old Jenevy over three months to be able to see a specialist who diagnosed her with a life-threatening allergy. Join the campaign and take action to fully fund Medi-Cal for California.",
