...
var parts = {
  ...
  knee: {
    ...
    twitter: "After an accident, you shouldn't need to wait months for surgery b/c you have Medi-Cal " + marks[0].twitter + " " + marks[1].twitter,
  ...
  lungs: {
    name: "Kristi, age 32, Fresno, Business Administration Student & Law Clerk",
    ...
    email: "Would you take expired medication? What if your only other choice was no medication at all?<br><br>Kristi Johnson in Fresno had to face that choice for nearly six months.<br><br>Kristi is a business administration student with asthma, and she is covered by Medi-Cal. When she called to make an appointment with her doctor, Kristi discovered the doctor was not able to accept new Medi-Cal patients. It took nearly three months for Kristi just to get an appointment with another doctor to renew her asthma prescriptions, and in the meantime she relied on expired medication to treat her condition.<br><br>Doctors like Kristi's can't afford to take new Medi-Cal patients because of California's low reimbursement rates. That means patients with chronic conditions like Kristi find themselves unable to get their medication.<br><br>Please support fully funding Medi-Cal, and help people like Kristi to get the care they need.<br><br>Sincerely,<br><br>"
  },
  ...
  leftArm: {
    ...
    email: "For more than three months, nine-year-old Jenevy Guzman had no treatment for what turned out to be a potentially life-threatening allergy.<br><br>Jenevy went to the doctor with a rash on her arm that was so bad it was beginning to blister, bleed, and spread to her face, eyes, and across her body. But even though she got a referral to a dermatologist, Jenevy still had to wait more than three months for an appointment.<br><br>Now she has been diagnosed with an allergy so severe that she needs to take an epi-pen with her wherever she goes.<br><br>It's hard for new Medi-Cal patients like Jenevy to get an appointment with a specialist because low Medi-Cal reimbursement rates mean few specialists are able to afford to see or treat them. That puts kids like Jenevy at serious risk when their conditions go undiagnosed and untreated.<br><br>Please support fully funding Medi-Cal, and help kids like Jenevy get the care they need.<br><br>Sincerely,<br><br>"
  },
  ...
  rightHand: {
    ...
    email: "How can a musician work if he can't use his hands?<br><br>Gilberto Uribe is a mariachi in Oakland, but he suffers from arthritis and diabetes, which causes terrible pain in his hands.<br><br>Gilberto has been waiting three months for an appointment with a doctor who accepts new Medi-Cal patients so he can get the care and medication he needs to manage his conditions and continue working as a musician.<br><br>Low Medi-Cal payment rates to doctors make it hard for patients like Gilberto to get timely care because there are too few doctors who can afford to accept new Medi-Cal patients. That means chronic conditions get worse, which impacts quality of life and the ability of Californians to stay employed.<br><br>Please support fully funding Medi-Cal to help people like Gilberto get the care they need.<br><br>Sincerely,<br><br>"
  }
